...
(function (root, factory) {
    ...
    var defaultOptions = {
        ...
        onclose: null,   // close event handler
    ...
    // to close timer doing his job, user close
    Timer.prototype.close = function () {
        if (!/started|paused|restarted|stopped/.test(this._.status)) return this
        clear.call(this, true)
        this._.repeat = 0;
        this._.status = 'closed'
        trigger.call(this, 'onclose', Object.assign((this._.args || {}), { spend: this.spend }))
        return this
    }
